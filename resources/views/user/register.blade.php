    ...
    <form class="w-full max-w-sm mx-auto m-48 p-6 border rounded  border-transparent" id="register" action="/register" method="POST">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full px-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="email" placeholder="emaill@example.com" name="email">
               @error('email')
            <div class="w-full"><p class="text-red-500">{{$message}}</p></div>
               @enderror
              </div>
