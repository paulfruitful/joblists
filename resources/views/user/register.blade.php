...
<body>
    <section class="dark:bg-gray-800 dark:text-gray-100">
        <div class="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 xl:max-w-3xl">
            <h1 class="text-4xl font-bold leading-none sm:text-5xl red-700">Join 
                <span class="text-indigo-800">Now</span>
            </h1>
    ...
    <form class="w-full max-w-sm mx-auto m-48 p-6 border rounded  border-transparent" id="register" action="/register" method="POST">
        ...
        <div class="md:flex md:items-center">
            ...
            <div class="md:w-2/3">
              <button class="shadow bg-gray-900 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                Sign Up
              </button>
            </div>
          </div>
