...
>
  <div class="flex justify-center items-center h-full">
    <div class="text-center text-white px-6 md:px-12">
      <h1 class="text-3xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">
        Welcome <span class="text-sm">{{auth()->user()->name}}</span><br /><span class="text-2xl">A Platform For Posting Jobs And Getting Jobs</span>
      </h1>
      <a
      href="?page=1"
