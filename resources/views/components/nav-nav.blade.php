  ...
  <div class="relative z-10 bg-black shadow">
    ...
    <div x-show="menu" class="block md:hidden">
      <div class="px-2 pt-2 pb-3">
        ...
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold font-medium hover:bg-red-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out"> Jobs</a>
