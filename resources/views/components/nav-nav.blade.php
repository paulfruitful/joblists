  ...
  <div class="relative z-10 bg-black shadow">
        ...
        <div class="flex items-center px-2 lg:px-0">
          ...
          <div class="hidden lg:block lg:ml-2">
            <div class="flex">
              ...
              <a href="/manage" class="ml-4 px-3 py-2 rounded-md text-md leading-5 font-medium text-white font-semibold hover:bg-red-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Jobs</a>
    ...
    <div x-show="menu" class="block md:hidden">
      <div class="px-2 pt-2 pb-3">
        ...
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold font-medium hover:bg-red-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Manage Listings </a>
        <a href="#" class="mt-1 block px-3 py-2 rounded-md text-white font-semibold font-medium hover:bg-red-500 focus:outline-none focus:text-white focus:bg-gray-700 transition duration-150 ease-in-out">Received Applications</a>
