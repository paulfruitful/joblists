...
<div class="max-w-sm relative">
    <a href="/{{$list->id}}">
<div class="border-2 relative border-gray box-content block border-rounded overflow-hidden p-12 mb-6 flex hover:border-gray-900 w-screen shadow-lg shadow-blacks  ">
