  ...
  <div class="flex bg-white" style="height:600px;">
      <div class="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
          <div>
              ...
              <p class="mt-2 text-sm text-gray-500 md:text-base">Getting A Job Or An Internship Role As A Junior Developer Or Fresher Can Be Tiring.<br> Joblists was built for you to make finding jobs and gigs easily, join the network today by clicking the sign up button. </p>
