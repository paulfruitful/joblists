...
<script src="//unpkg.com/alpinejs" defer></script>
    ...
    <body>
        <x-nav-nav/>
            ...
            <h1 class="text-white text-2xl font-bold tracking-tight mb-12 m-4 p-6 bg-indigo-900 ">Your Job Listings <span class="bg-gray-300 text-white rounded relative"></span></h1>
        </div>
