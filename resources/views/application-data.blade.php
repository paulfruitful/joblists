            ...
            <div class="flex flex-row flex-wrap py-4">
                ...
                <main role="main" class="w-full sm:w-2/3 md:w-3/4 pt-1 px-2">
                    ...
                    <ul class="mt-4">
                        ...
                        <li class="  border-solid border-b-2 border-gray-400 mb-8"><span class="text-gray-900 font-bold ">Resume: </span><a href="/storage/{{$application->cv}}" class="text-purple-800">Click The Link</a></li>
                        <li class="  border-solid border-b-2 border-gray-400 mb-8"><span class="text-gray-900 font-bold ">Portfolio: </span> {{$application->name}}</li>
                    ...
                    <div class="mx-auto"></div>
                     ...
                     <button type="submit" class="inline-flex bottom-0 right-0  justify-center relative py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-800 hover:bg-red-600">Reject Application</button>
                      <a href="/{{$application->id}}/edit" class="py-2 mx-4 px-4 bg-green-900 text-white border hover:bg-gray-700 border-transparent rounded-md">Accept Application</a>
                   </form> </div>
                  </section>
